...
### 1.1 Specification organization
...
4. Lexical analysis
   Describes the work of lexical analysator.
...
9. Control flow constructions
   Describes control flow constructions (`for`, `while`, `if`, etc.)
